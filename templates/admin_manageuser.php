              ...
              <ul class="navbar-nav ms-auto pe-5">
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#logout">Log Out</a>
                    </li>
                  </ul>
                </li>
      ...
      <main class="p-3">
        ...
        <div class="container-fluid border  shadow-lg bg-body-tertiary rounded">
          <div class="col-2 ms-auto p-2">
            <a href="/" class="btn btn-primary mb-3" style="width:100%" data-bs-toggle="modal"
              data-bs-target="#addusers" aria-label="Set Schedule">
              ...
              <div class="table-responsive">
                ...
                <table id="myTable" class="table table-hover pt-1">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/update_admin_manageuser{{row[0] }}" style="width:100%" class="btn btn-info btn-md"
                        data-bs-toggle="modal" data-bs-target="#editUser{{ row[0] }}">Edit</a>
                    </td>
                  </tr>
                  <!-- edit user -->
                  <div class="modal fade" id="editUser{{ row[0] }}" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="editScheduledropLabel" aria-hidden="true">
                    <div class="modal-dialog  modal-xl">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="{{ url_for('update_admin_manageuser') }}" method="POST"
                            enctype="multipart/form-data">
                            <div class="row  m-3">
                              <div class="col-3">
                                <label for="userType" class="form-label">User Type</label>
                                <select class="form-select pb-1" id="userType" name="userType"
